...
export const DASHBOARD_NAV_ITEMS: DashboardNavItem[] = [
  ...
  { href: '/dashboard/scan', id: 'scan', label: 'Scan caisse', paths: ['M4 7V5a1 1 0 0 1 1-1h2', 'M17 4h2a1 1 0 0 1 1 1v2', 'M20 17v2a1 1 0 0 1-1 1h-2', 'M7 20H5a1 1 0 0 1-1-1v-2', 'M7 12h10'] },
